...
public interface ClassScoreSercive {



    /**
     * 增加一条新的课程测试记录
     * @param classScore 一个ClassExam对象
     */
...
//    void deleteByCId(@Param("cId") int cId);
     ...
     * @return 获取到的所有课程测试项
     */
//    List<ClassScore> selectBySId(@Param("sId") int sId);
     ...
     * @return 该学生的该课程成绩
     */
    ClassScore[] selectBySIdAndCId(@Param("sId") int sId, @Param("cId") int cId);
     ...
     * @param newScore 新成绩
     */
    void updateScoreBySIdAndCId(@Param("sId") int sId,
                                @Param("cId") int cId,
